local path = "weapons/sandstorm_reloaded/"
local pref = "TFA_SR"

TFA.AddWeaponSound(pref .. ".Draw", { 
	path.."foley/weapon_draw_01.wav",
	path.."foley/weapon_draw_02.wav",
	path.."foley/weapon_draw_03.wav",
	path.."foley/weapon_draw_04.wav",
	path.."foley/weapon_draw_05.wav",
	path.."foley/weapon_draw_06.wav"},
")")

TFA.AddWeaponSound(pref .. ".Holster", { 
	path.."foley/weapon_holster_01.wav",
	path.."foley/weapon_holster_02.wav",
	path.."foley/weapon_holster_03.wav",
	path.."foley/weapon_holster_04.wav",
	path.."foley/weapon_holster_05.wav",
	path.."foley/weapon_holster_06.wav"},
")")

TFA.AddWeaponSound(pref .. ".LeanIn", { 
	path.."foley/lean_in_01.wav",
	path.."foley/lean_in_02.wav",
	path.."foley/lean_in_03.wav",
	path.."foley/lean_in_04.wav",
	path.."foley/lean_in_05.wav",
	path.."foley/lean_in_06.wav"},
")")

TFA.AddWeaponSound(pref .. ".LeanOut", { 
	path.."foley/lean_out_01.wav",
	path.."foley/lean_out_02.wav",
	path.."foley/lean_out_03.wav",
	path.."foley/lean_out_04.wav",
	path.."foley/lean_out_05.wav",
	path.."foley/lean_out_06.wav"},
")")
